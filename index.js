...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 40) { 
            	client.sendText(chat.id, `Desculpe, o membro é muito pequeno ${totalMem}, Inivite Lagi Bot Jika se o membro chegar a 40`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
